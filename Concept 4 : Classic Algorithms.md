...
## 4. Logistic Regression (The Straight-Line Thinker)
...
## 5. K-Nearest Neighbors (KNN) (The Copycat)
...
## 7. Linear Regression (The Ruler) - *Supervised | Regression*
...
## 9. K-Means Clustering (The Organizer) - *Unsupervised | Clustering*
...
## 10. Hierarchical Clustering (The Family Tree) - *Unsupervised | Clustering*
